...
def _parse_params(request):
    ...
    return start_date, end_date, account_id, status, today


def _get_extrato_data(user, start_date, end_date, account_id, status, today):
...
@login_required
def extrato(request):
    start_date, end_date, account_id, status, _ = _parse_params(request)
    context = _get_extrato_data(
        request.user, start_date, end_date, account_id, status, date.today()
    )
    context.update({
...
def extrato_pdf(request):
    start_date, end_date, account_id, status, today = _parse_params(request)
    context = _get_extrato_data(
        request.user, start_date, end_date, account_id, status, today
    )
